 ...
 * \note_accuracy_double
 */
extern __host__ __device__ __device_builtin__ double rnorm4d(double a, double b, double c, double d) __THROW;
 ...
 * \note_accuracy_double
 */
extern __host__ __device__ __device_builtin__ double norm(int dim, double const * t) __THROW;
 ...
 * \note_accuracy_double
 */
extern __host__ __device__ __device_builtin__ double rnorm(int dim, double const * t) __THROW;
...
extern __host__ __device__ __device_builtin__ float rnormf(int dim, float const * a) __THROW;
 ...
 * \note_accuracy_single
 */
extern __host__ __device__ __device_builtin__ float normf(int dim, float const * a) __THROW;
 ...
 * \note_accuracy_single
 */
extern __host__ __device__ __device_builtin__ float rnorm4df(float a, float b, float c, float d) __THROW;
...
#endif
extern __host__ __device__ __cudart_builtin__ bool signbit(long double) __SIGNBIT_THROW;
 ...
 * nonzero value if and only if \p a is negative. 
 */
extern __host__ __device__ __cudart_builtin__ __RETURN_TYPE signbit(double) __SIGNBIT_THROW;
 ...
 * if and only if \p a is negative.  
 */
extern __host__ __device__ __cudart_builtin__ __RETURN_TYPE signbit(float) __SIGNBIT_THROW;
...
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl abs(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ double   __cdecl abs(double);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl fabs(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl ceil(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl floor(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl sqrt(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl pow(float, float);

#if !defined(__QNX__)
     
#if defined(__GNUC__) && __cplusplus >= 201103L && !defined(_LIBCPP_VERSION)
template<typename _Tp, typename _Up>
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__
...
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl log(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl log10(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl fmod(float, float);
extern __host__ __device__ __cudart_builtin__ float    __cdecl modf(float, float*);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl exp(float);
extern __host__ __device__ __cudart_builtin__ float    __cdecl frexp(float, int*);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl ldexp(float, int);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl asin(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl sin(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl sinh(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl acos(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl cos(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl cosh(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl atan(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl atan2(float, float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl tan(float);
extern __host__ __device__ __cudart_builtin__ __CUDA_CONSTEXPR__ float    __cdecl tanh(float);
