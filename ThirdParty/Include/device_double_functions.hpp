...
__DEVICE_DOUBLE_FUNCTIONS_DECL__ double __dsub_rn(double a, double b)
{
  double res;
...
__DEVICE_DOUBLE_FUNCTIONS_DECL__ double __dsub_rz(double a, double b)
{
  double res;
...
__DEVICE_DOUBLE_FUNCTIONS_DECL__ double __dsub_ru(double a, double b)
{
  double res;
...
__DEVICE_DOUBLE_FUNCTIONS_DECL__ double __dsub_rd(double a, double b)
{
  double res;
