...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(char *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(signed char *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(char1 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(char2 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(char4 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(unsigned char *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(uchar1 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(uchar2 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(uchar4 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(short *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(short1 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(short2 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(short4 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(unsigned short *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(ushort1 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(ushort2 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(ushort4 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(int *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(int1 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(int2 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(int4 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(unsigned int *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(uint1 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(uint2 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(uint4 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(long *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(long1 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(long2 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(long4 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  int4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4s32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(unsigned long *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(ulong1 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(ulong2 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(ulong4 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  uint4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4u32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(float *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  float4 tmp;
  if (comp == 0) {
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(float1 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  float4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4f32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(float2 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  float4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4f32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
...
__TEXTURE_INDIRECT_FUNCTIONS_DECL__ void tex2Dgather(float4 *retVal, cudaTextureObject_t texObject, float x, float y, int comp)
{
  float4 tmp;
  if (comp == 0) {
    __tld4_r_2d_v4f32_f32(texObject, x, y, &tmp.x, &tmp.y, &tmp.z, &tmp.w);
