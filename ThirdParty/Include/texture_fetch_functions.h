...
#define __TEX_ASM(X) __asm(X)
#else
#define __TEX_ASM(X)
#endif

template <class T>
extern __device__ __device_builtin__ uint4 __utexfetchi1D(T, int4) __TEX_ASM("__utexfetchi1D");
template <class T>
extern __device__ __device_builtin__ int4 __itexfetchi1D(T, int4)  __TEX_ASM("__itexfetchi1D");
template <class T>
extern __device__ __device_builtin__ float4 __ftexfetchi1D(T, int4)  __TEX_ASM("__ftexfetchi1D");

template <class T>
extern __device__ __device_builtin__ uint4 __utexfetch1D(T, float4)  __TEX_ASM("__utexfetch1D");
template <class T>
extern __device__ __device_builtin__ uint4 __utexfetch2D(T, float4)  __TEX_ASM("__utexfetch2D");
template <class T>
extern __device__ __device_builtin__ uint4 __utexfetch3D(T, float4)  __TEX_ASM("__utexfetch3D");

template <class T>
extern __device__ __device_builtin__ int4 __itexfetch1D(T, float4)  __TEX_ASM("__itexfetch1D");
template <class T>
extern __device__ __device_builtin__ int4 __itexfetch2D(T, float4)  __TEX_ASM("__itexfetch2D");
template <class T>
extern __device__ __device_builtin__ int4 __itexfetch3D(T, float4)  __TEX_ASM("__itexfetch3D");

template <class T>
extern __device__ __device_builtin__ float4 __ftexfetch1D(T, float4)  __TEX_ASM("__ftexfetch1D");
template <class T>
extern __device__ __device_builtin__ float4 __ftexfetch2D(T, float4)  __TEX_ASM("__ftexfetch2D");
template <class T>
extern __device__ __device_builtin__ float4 __ftexfetch3D(T, float4)  __TEX_ASM("__ftexfetch3D");

template <class T>
extern __device__ __device_builtin__ uint4 __utexfetchcube(T, float4)  __TEX_ASM("__utexfetchcube");
template <class T>
extern __device__ __device_builtin__ int4 __itexfetchcube(T, float4)  __TEX_ASM("__itexfetchcube");
template <class T>
extern __device__ __device_builtin__ float4 __ftexfetchcube(T, float4)  __TEX_ASM("__ftexfetchcube");

template <class T>
extern __device__ __device_builtin__ uint4 __utexfetchl1D(T, float4, int)  __TEX_ASM("__utexfetchl1D");
template <class T>
extern __device__ __device_builtin__ uint4 __utexfetchl2D(T, float4, int)  __TEX_ASM("__utexfetchl2D");

template <class T>
extern __device__ __device_builtin__ int4 __itexfetchl1D(T, float4, int)  __TEX_ASM("__itexfetchl1D");
template <class T>
extern __device__ __device_builtin__ int4 __itexfetchl2D(T, float4, int)  __TEX_ASM("__itexfetchl2D");

template <class T>
extern __device__ __device_builtin__ float4 __ftexfetchl1D(T, float4, int)  __TEX_ASM("__ftexfetchl1D");
template <class T>
extern __device__ __device_builtin__ float4 __ftexfetchl2D(T, float4, int)  __TEX_ASM("__ftexfetchl2D");


template<typename T>
extern __device__ __device_builtin__ uint4 __utexfetchlcube(T, float4, int) __TEX_ASM("__utexfetchlcube");

template<typename T>
extern __device__ __device_builtin__ int4 __itexfetchlcube(T, float4, int) __TEX_ASM("__itexfetchlcube");

template<typename T>
extern __device__ __device_builtin__ float4 __ftexfetchlcube(T, float4, int) __TEX_ASM("__ftexfetchlcube");
...
template<typename T> 
extern __device__ __device_builtin__  int4 __itex2Dgather0(T, float2) __TEX_ASM("__itex2Dgather0");
template<typename T> 
extern __device__ __device_builtin__  int4 __itex2Dgather1(T, float2) __TEX_ASM("__itex2Dgather1");
template<typename T> 
extern __device__ __device_builtin__  int4 __itex2Dgather2(T, float2) __TEX_ASM("__itex2Dgather2");
template<typename T> 
extern __device__ __device_builtin__  int4 __itex2Dgather3(T, float2) __TEX_ASM("__itex2Dgather3");


template<typename T> 
extern __device__ __device_builtin__  uint4 __utex2Dgather0(T, float2) __TEX_ASM("__utex2Dgather0");
template<typename T> 
extern __device__ __device_builtin__  uint4 __utex2Dgather1(T, float2) __TEX_ASM("__utex2Dgather1");
template<typename T> 
extern __device__ __device_builtin__  uint4 __utex2Dgather2(T, float2) __TEX_ASM("__utex2Dgather2");
template<typename T> 
extern __device__ __device_builtin__  uint4 __utex2Dgather3(T, float2) __TEX_ASM("__utex2Dgather3");


template<typename T> 
extern __device__ __device_builtin__  float4 __ftex2Dgather0(T, float2) __TEX_ASM("__ftex2Dgather0");
template<typename T> 
extern __device__ __device_builtin__  float4 __ftex2Dgather1(T, float2) __TEX_ASM("__ftex2Dgather1");
template<typename T> 
extern __device__ __device_builtin__  float4 __ftex2Dgather2(T, float2) __TEX_ASM("__ftex2Dgather2");
template<typename T> 
extern __device__ __device_builtin__  float4 __ftex2Dgather3(T, float2) __TEX_ASM("__ftex2Dgather3");
...
template<typename T>
extern __device__ __device_builtin__  uint4 __utexfetchlod1D(T, float4, float) __TEX_ASM("__utexfetchlod1D");
template<typename T>
extern __device__ __device_builtin__  uint4 __utexfetchlod2D(T, float4, float) __TEX_ASM("__utexfetchlod2D");
template<typename T>
extern __device__ __device_builtin__  uint4 __utexfetchlod3D(T, float4, float) __TEX_ASM("__utexfetchlod3D");

template<typename T>
extern __device__ __device_builtin__  int4 __itexfetchlod1D(T, float4, float) __TEX_ASM("__itexfetchlod1D");
template<typename T>
extern __device__ __device_builtin__  int4 __itexfetchlod2D(T, float4, float) __TEX_ASM("__itexfetchlod2D");
template<typename T>
extern __device__ __device_builtin__  int4 __itexfetchlod3D(T, float4, float) __TEX_ASM("__itexfetchlod3D");

template<typename T>
extern __device__ __device_builtin__  float4 __ftexfetchlod1D(T, float4, float) __TEX_ASM("__ftexfetchlod1D");
template<typename T>
extern __device__ __device_builtin__  float4 __ftexfetchlod2D(T, float4, float) __TEX_ASM("__ftexfetchlod2D");
template<typename T>
extern __device__ __device_builtin__  float4 __ftexfetchlod3D(T, float4, float) __TEX_ASM("__ftexfetchlod3D");


template<class T> 
extern __device__ __device_builtin__  uint4 __utexfetchlodcube(T, float4, float) __TEX_ASM("__utexfetchlodcube");
template<class T> 
extern __device__ __device_builtin__  int4 __itexfetchlodcube(T, float4, float) __TEX_ASM("__itexfetchlodcube");
template<class T> 
extern __device__ __device_builtin__  float4 __ftexfetchlodcube(T, float4, float) __TEX_ASM("__ftexfetchlodcube");

template<class T> 
extern __device__ __device_builtin__  uint4 __utexfetchlodl1D(T, float4, int, float) __TEX_ASM("__utexfetchlodl1D");
template<class T> 
extern __device__ __device_builtin__  uint4 __utexfetchlodl2D(T, float4, int, float) __TEX_ASM("__utexfetchlodl2D");

template<class T> 
extern __device__ __device_builtin__  int4 __itexfetchlodl1D(T, float4, int, float) __TEX_ASM("__itexfetchlodl1D");
template<class T> 
extern __device__ __device_builtin__  int4 __itexfetchlodl2D(T, float4, int, float) __TEX_ASM("__itexfetchlodl2D");

template<class T> 
extern __device__ __device_builtin__  float4 __ftexfetchlodl1D(T, float4, int, float) __TEX_ASM("__ftexfetchlodl1D");
template<class T> 
extern __device__ __device_builtin__  float4 __ftexfetchlodl2D(T, float4, int, float) __TEX_ASM("__ftexfetchlodl2D");

template<typename T>
extern __device__ __device_builtin__  uint4 __utexfetchlodlcube(T, float4, int, float) __TEX_ASM("__utexfetchlodlcube");
template<typename T>
extern __device__ __device_builtin__  int4 __itexfetchlodlcube(T, float4, int, float) __TEX_ASM("__itexfetchlodlcube");
template<typename T>
extern __device__ __device_builtin__  float4 __ftexfetchlodlcube(T, float4, int, float) __TEX_ASM("__ftexfetchlodlcube");


template<typename T>
extern __device__ __device_builtin__  uint4 __utexfetchgrad1D(T, float4, float4, float4) __TEX_ASM("__utexfetchgrad1D");
template<typename T>
extern __device__ __device_builtin__  uint4 __utexfetchgrad2D(T, float4, float4, float4) __TEX_ASM("__utexfetchgrad2D");
template<typename T>
extern __device__ __device_builtin__  uint4 __utexfetchgrad3D(T, float4, float4, float4) __TEX_ASM("__utexfetchgrad3D");

template<typename T>
extern __device__ __device_builtin__  int4 __itexfetchgrad1D(T, float4, float4, float4) __TEX_ASM("__itexfetchgrad1D");
template<typename T>
extern __device__ __device_builtin__  int4 __itexfetchgrad2D(T, float4, float4, float4) __TEX_ASM("__itexfetchgrad2D");
template<typename T>
extern __device__ __device_builtin__  int4 __itexfetchgrad3D(T, float4, float4, float4) __TEX_ASM("__itexfetchgrad3D");


template<typename T>
extern __device__ __device_builtin__  float4 __ftexfetchgrad1D(T, float4, float4, float4) __TEX_ASM("__ftexfetchgrad1D");
template<typename T>
extern __device__ __device_builtin__  float4 __ftexfetchgrad2D(T, float4, float4, float4) __TEX_ASM("__ftexfetchgrad2D");
template<typename T>
extern __device__ __device_builtin__  float4 __ftexfetchgrad3D(T, float4, float4, float4) __TEX_ASM("__ftexfetchgrad3D");

template<typename T>
extern __device__ __device_builtin__ uint4 __utexfetchgradl1D(T, float4, int, float4, float4) __TEX_ASM("__utexfetchgradl1D");
template<typename T>
extern __device__ __device_builtin__ uint4 __utexfetchgradl2D(T, float4, int, float4, float4) __TEX_ASM("__utexfetchgradl2D");

template<typename T>
extern __device__ __device_builtin__ int4 __itexfetchgradl1D(T, float4, int, float4, float4) __TEX_ASM("__itexfetchgradl1D");
template<typename T>
extern __device__ __device_builtin__ int4 __itexfetchgradl2D(T, float4, int, float4, float4) __TEX_ASM("__itexfetchgradl2D");

template<typename T>
extern __device__ __device_builtin__ float4 __ftexfetchgradl1D(T, float4, int, float4, float4) __TEX_ASM("__ftexfetchgradl1D");
template<typename T>
extern __device__ __device_builtin__ float4 __ftexfetchgradl2D(T, float4, int, float4, float4) __TEX_ASM("__ftexfetchgradl2D");
