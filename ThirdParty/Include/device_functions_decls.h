 ...
 * If one of the input arguments is 0, returns the other argument
 *
 * \note_accuracy_single
 */
 ...
 * \p x and \p y without undue overflow or underflow.
 *
 * \return Returns inverted length of the hypotenuse 
 ...
 *
 * Calculate the reciprocal length of three dimensional vector \p p in euclidean space undue overflow or underflow.
 *
...
/**
 * \ingroup CUDA_MATH_SINGLE
 * \brief Calculate the square root of the sum of squares of four coordinates of argument.
 *
 ...
 * \brief Calculate the square root of the sum of squares of three coordinates of argument.
 *
 * Calculate the length of three dimensional vector \p p in euclidean space undue overflow or underflow.
 *
 * \return Returns the length of the 3D vector
 * \latexonly $\sqrt{p.x^2+p.y^2+p.z^2}$ \endlatexonly
 * \xmlonly
 ...
 * \brief Calculate the reciprocal square root of the sum of squares of three coordinates of argument.
 *
 * Calculate reciprocal of the length of three dimensional vector \p p in euclidean space undue overflow or underflow.
 *
 * \return Returns inverted length of the 3D vector
 * \latexonly $\sqrt{p.x^2+p.y^2+p.z^2}$ \endlatexonly
 * \xmlonly
 ...
 * \brief Calculate the square root of the sum of squares of four coordinates of argument.
 *
 * Calculate the length of four dimensional vector \p p in euclidean space undue overflow or underflow.
 *
 * \return Returns the length of the 4D vector
 * \latexonly $\sqrt{p.x^2+p.y^2+p.z^2+p.t^2}$ \endlatexonly
 * \xmlonly
 ...
 * 
 * \return
 * Returns the largest integer value which is less than or equal to x
...
#undef __DEVICE_FUNCTIONS_DECLS__
